...
For HTML reports configure WhiteBread with the HTML outputer and optionally a file name for the document:
...
**NOTE:** the directory tree above the given path must exist.
